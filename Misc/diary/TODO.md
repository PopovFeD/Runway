...
- [ ] Управляющие команды
- [ ] Оптимизация логов, сведение их в одну систему
...
- [ ] Кастомные иконки, самые простые. Может, использовать svgб лежащие у меня на компьютере, с трансляцией их в .ico
